<template>
	<header>
		<div class="warp">
          ...
          <div class="action_center">Welcome to the text checking system</div>
					<div class="action_right">
						<el-dropdown @command="handleCommand">
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item command="/user/info">Personal Information</el-dropdown-item>
								<el-dropdown-item command="/user/password">change password</el-dropdown-item>
								<el-dropdown-item command="/quit" divided>abort</el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
					</div>
