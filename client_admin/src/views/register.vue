			...
			<el-row>
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<el-form-item label="ConfPassword" prop="confirm_password">
							<el-input type="password" v-model="confirm_password" placeholder="5 to 16 characters"
								autocomplete="off">
							</el-input>
						</el-form-item>

						<el-form-item label="Nickname" prop="nickname">
							<el-input type="text" v-model="form.nickname" placeholder="nickname">
							</el-input>
						</el-form-item>
						...
						<el-form-item label="Identities" prop="user_group">
							<el-select v-model="form.user_group" placeholder="identities">
						...
						<router-link class="el-button el-button--primary" to="./login" >Return</router-link>
