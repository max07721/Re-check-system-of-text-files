		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="上课地点">
									<el-input v-model="query.class_location"></el-input>
								</el-form-item>
				</el-col>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/course_information/table','add') || $check_action('/course_information/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','experimental_arrangement')" min-width="200">
					...
					<el-table-column prop="class_location" @sort-change="$sortChange" label="上课地点"
				v-if="user_group == '管理员' || $check_field('get','class_location')" min-width="200">
					</el-table-column>
					<el-table-column prop="course_arrangement" @sort-change="$sortChange" label="课程安排"
				v-if="user_group == '管理员' || $check_field('get','course_arrangement')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/course_information/table','set') || $check_action('/course_information/view','set') || $check_action('/course_information/view','get') || $check_action('/选课/table','add') || $check_action('/选课/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/course_information/table','set') || $check_action('/course_information/view','set') || $check_action('/course_information/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/course_selection/view')" v-if="user_group == '管理员' || $check_action('/course_selection/table','add') || $check_action('/course_selection/view','add')">
						<span>选课</span>
					</el-button>
							</template>
			</el-table-column>
