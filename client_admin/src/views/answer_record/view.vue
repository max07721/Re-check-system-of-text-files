	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="实验解答" prop="experimental_solution">
					<quill-editor v-model="form['experimental_solution']"
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item>
					<el-button type="primary" @click="submit()" :disabled="textLength > 10000">提交</el-button>
...
<script>
	...
	export default {
		...
		watch: {
			'form.experimental_solution': function(newValue, oldValue) {
