		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/overall_evaluation/table','add') || $check_action('/overall_evaluation/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/overall_evaluation/table','del') || $check_action('/overall_evaluation/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','experimental_topic')" min-width="200">
					...
					<el-table-column prop="experimental_performance" @sort-change="$sortChange" label="实验表现"
				v-if="user_group == '管理员' || $check_field('get','experimental_performance')" min-width="200">
					</el-table-column>
					<el-table-column prop="evaluation_rules" @sort-change="$sortChange" label="评价规则"
				v-if="user_group == '管理员' || $check_field('get','evaluation_rules')" min-width="200">
					</el-table-column>
					<el-table-column prop="evaluation_score" @sort-change="$sortChange" label="整体成绩"
				v-if="user_group == '管理员' || $check_field('get','evaluation_score')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/overall_evaluation/table','set') || $check_action('/overall_evaluation/view','set') || $check_action('/overall_evaluation/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/overall_evaluation/table','set') || $check_action('/overall_evaluation/view','set') || $check_action('/overall_evaluation/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/overall_evaluation/get_list?like=0",
				url_del: "~/api/overall_evaluation/del?",
